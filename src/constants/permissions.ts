...
export const PERMISSIONS = {
  ...
  PENDING_CUSTOMER_DELETE: 'pending_customer:delete',
...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  // 2. 經理 / 審批主管 (MANAGER)：審批核准、特許覆蓋、全區調度、班表管理、客戶維護、待排客戶、通知範本管理
  MANAGER: [
    ...
    PERMISSIONS.PENDING_CUSTOMER_DELETE,
  ...
  // 3. 排班組長 / 行政 (LEADER)：任務建立、排班編輯、特許覆蓋、客戶維護、指定排休、待排客戶、通知發送、異動進度追蹤
  LEADER: [
    PERMISSIONS.TASK_VIEW,
    PERMISSIONS.TASK_CREATE,
    PERMISSIONS.TASK_EDIT,
  ...
  // 4. 現場專員 / 一般員工 (STAFF)：檢視本人與同班別班表、接收通知、全域地圖、客戶資料檢視、個人資料維護
  STAFF: [
    PERMISSIONS.SCHEDULE_VIEW,
    PERMISSIONS.NOTIFICATION_VIEW,
    PERMISSIONS.MAP_VIEW,
